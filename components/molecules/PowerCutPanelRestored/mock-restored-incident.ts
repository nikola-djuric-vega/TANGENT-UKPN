...
export const mockRestoredIncident: Incident = {
  incidentReference: 'INCD-276275-Z',
  panelContentUrl: '/power-cut/map/power-back-on?incidentId=INCD-276275-Z',
  steps: [
    {
      active: false,
      date: '2021-12-26T11:26:42',
      message:
        '<p>We became aware of a power cut at 11:26. We’re sorry for any disruption this may have caused you. We didn’t know in advance there would be a power cut but now that we know, our teams will do everything they can to get your power back quickly. </p>',
      name: StepName.POWER_CUT_REPORTED,
    },
    {
      active: false,
      date: '2022-02-04T08:03:21',
      message:
  ...
  ukpnIncident: {
    ...
    plannedDate: null,
    receivedDate: '2021-12-26T11:26:42',

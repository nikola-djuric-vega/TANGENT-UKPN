import HelpAndAdviceItem, { HelpAndAdviceItemProps } from './HelpAndAdviceItem'
import { Story, Meta } from '@storybook/react'
import { IconNames } from '_types/local'
import React from 'react'

export default {
  title: 'Molecules/HelpAndAdviceItem',
  component: HelpAndAdviceItem,
} as Meta

const Template: Story<HelpAndAdviceItemProps> = (args) => (
  <HelpAndAdviceItem {...args} />
)
...
Default.args = {
  helpAndAdviceItem: {
    ...
    helpAndAdviceVideoPlayText: 'UKPN upgrade',
  },
}

import { PSRFormThankYouPage as PSRFormThankYouPageType } from '_types/CMS/pages/form-pages'
...
interface PSRFormThankYouPageProps {
  data: PSRFormThankYouPageType
}

export const PSRFormThankYouPage = ({ data }: PSRFormThankYouPageProps) => {
  return (
    <div>

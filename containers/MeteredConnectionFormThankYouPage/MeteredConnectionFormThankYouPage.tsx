import { MeteredConnectionFormThankYouPage as MeteredConnectionFormThankYouPageType } from '_types/CMS/pages/form-pages'
...
interface MeteredConnectionFormThankYouPageProps {
  data: MeteredConnectionFormThankYouPageType
}

export const MeteredConnectionFormThankYouPage = ({
  data,
}: MeteredConnectionFormThankYouPageProps) => {
  return (
    <div>

import { UnMeteredConnectionFormThankYouPage as UnMeteredConnectionFormThankYouPageType } from '_types/CMS/pages/form-pages'
...
interface UnMeteredConnectionFormThankYouPageProps {
  data: UnMeteredConnectionFormThankYouPageType
}

export const UnMeteredConnectionFormThankYouPage = ({
  data,
}: UnMeteredConnectionFormThankYouPageProps) => {
  return (
    <div>

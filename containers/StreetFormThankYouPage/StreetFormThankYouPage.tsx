import { StreetFormThankYouPage as StreetFormThankYouPageType } from '_types/CMS/pages/form-pages'
...
interface StreetFormThankYouPageProps {
  data: StreetFormThankYouPageType
}

export const StreetFormThankYouPage = ({
  data,
}: StreetFormThankYouPageProps) => {
  return (
    <div>
